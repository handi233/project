...
<head>
    ...
    <!-- title  -->
    <title>Pasien Baru | Klinik Arafah Husada</title>
                            ...
                            <div class="menu_area">
                                <nav class="navbar navbar-expand-lg navbar-light p-0">
                                    <div class="navbar-header navbar-header-custom">
                                        <!-- start logo -->
                                        <a href="index.html" class="navbar-brand logochange"><img id="logo" src="img/logos/logo-white.png" alt="logo"></a>
                                        <!-- end logo -->
                                    </div>
...
<table>
    <div class="tabs" tr td>
        <div class="card border-success mb-5" style="max-width: 40rem" style="max-height: 30rem"  ;>
  ...
  <div class="card-body text-success">
    ...
    <div class="form-group col-md-6">
      <label for="inputEmail4">No NIK</label>
      <input type="text" class="form-control"   name="no_nik" placeholder="No NIK">
    </div>
  <div class="form-row">
    <div class="form-group col-md-6">
  ...
  <div class="form-row">
    <div class="form-group col-md-6" class="form-control">
      <label for="tanggal_kunjung">Pilih Tanggal</label>
...
if(isset($_POST['submit'])){
    ...
    $poli=$_POST['poli'];
$insert = mysqli_query($con, "INSERT INTO pasien_baru (no_nik,nama,alamat,no_hp,email,tanggal_kunjung,poli) VALUES ('$no_nik','$nama','$alamat','$no_hp','$alamat_email','$tanggal_kunjung','$poli')") or die(mysqli_error());
if ($insert){
