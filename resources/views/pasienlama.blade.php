...
@endif
    <form method="POST" action="{{ route('pasienlamainput') }}">
     @csrf
    <table class="table table-bordered">
    <thead>
      <tr>
        <th style="text-align:center; margin-left:20px;">Pendaftaran Pasien Lama</th>
      </tr>
    </thead>
<tbody>
    <tr>
  ...
  <input type="text" class="form-control"value="{{ old('no_nik') }}" name="no_nik" autofocus required>
</div>
 <div class="mb-3">
